...
```{r, echo=FALSE,fig.cap="This dashboard was developed by the [UK Public Health Rapid Support Team](https://www.lshtm.ac.uk/research/centres-projects-groups/uk-phrst)", out.width = '100%', out.height="20%", fig.align='center'} 
...
### Cases by status at presentation 
...
table1(~ age_years  + sex  + 
         health_facility_name  + outcome + contact_cov19 +
         #factor(cough) + factor(sore_throat) + factor(fever) + factor(rapid_breathing) + factor(resp_distress) +
         onset_sample | detection_status , data=godata_clean, topclass="Rtable1-zebra",footnote="Data source: GoData") 
