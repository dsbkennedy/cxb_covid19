...
# 
# fdmn_pal_cases <- colorBin( "Blues", domain=case_shp_fdmn$total_cases, bins=3, na.color = "grey")
# fdmn_pal_deaths <- colorBin( "YlOrRd", domain=case_shp_fdmn$total_deaths, bins=3, na.color = "grey")
...
#               weight = 1,
#               fillOpacity = .6) %>% 
#   addLegend("bottomright", pal = fdmn_pal, values = ~fdmn_pal, title = "Number of cases")
